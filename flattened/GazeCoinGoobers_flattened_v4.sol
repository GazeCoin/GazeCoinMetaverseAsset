...
//
// Deployed to : v4 0xEAf465c5Fe0cf691a7159c269ae58271a1fF27bE on Ropsten
//
// Enjoy.
//
...
contract GazeCoinGoobers is ERC721Enumerable, MyERC721Metadata {
    ...
    constructor() MyERC721Metadata("GazeCoin Goobers v4", "GOOBv4") public {
    }

    // Mint and burn
    function mint(address to, string memory tokenType) public returns (uint256) {
        _tokenIds.increment();
